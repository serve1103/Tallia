...
대학 입학처 평가점수 환산 멀티테넌트 웹앱. Phase 0~11 코드 구현 완료 (PR #1), Phase 12(배포) 미진행.

## 구현 진행

`docs/task.md` Phase 0~12 순서대로. 현재 Phase 0~11 백엔드/프론트엔드 골격 완료, 테스트 98개 통과.
남은 작업: 프론트엔드 도메인 컴포넌트 상세, 엑셀 실구현, DB 연결 후 통합 테스트, 배포.
